...
function ExportCalls() {
    ...
    $.post('/CRM/AjaxExportCalls', { search: search, order: order }, function (data) {
        if (data.statusCode == 500) {
            window.location.href = "/Home/Error";
        }
        if (data == "0") {
...
function loadData(data) {
    ...
    $.each(data.data, function (index, item) {
        ...
        var callFreqdiv = ""
        var Callinaction = ""
        //Callinaction = $("<div id='eng-" + item.P_AllCallsReg + "' class='col-md-12 alert cgs' style='color:black; margin-left: 20px;width: 400px;background-color: gainsboro;margin-bottom: 0px;padding-bottom: 0px;padding-top: 0px;text-align: start;'><span>" + item.EngageStatus + "<span><b>&nbsp;" + item.EngageBy + "</b><span>&nbsp;&nbsp;" + item.EngageTime + "</span></div>");

        //if (item.Tags !== undefined && item.Tags != "") {
        //    var tagsRow = $("<div id='trtags-" + item.AllCallsReg_key + "' class='col-md-12' style='width: 400px;background-color: gainsboro;margin-bottom: 0px;padding-bottom: 3px;padding-top: 3px;text-align: start;color: black;margin-left: 20px;'><b>Tags: &nbsp;</b>" + item.Tags + "</div>");
        ...
        if (item.hasRemarks == "Y") {
            ...
            callFreqdiv = ("<div class='numberCircle' style='visibility:hidden;'>" + item.callFreqCount + "</div>")
            if (item.IsPendingMoreThanDays == "Y") {
                Parentdiv = $("<div id='MainDiv-" + item.AllCallsReg_key + "' class='col-md-12  clickable parentdiv maindiv opendetail' onmouseover='hoverId(this)' onmouseout='hoverNot(this)' style='background-color:rgb(146, 182, 219);'></div>");
                MoreDetailsdiv = $(("<div  class='MoreDetails' id='" + item.AllCallsReg_key + "'  style='opacity:1; background-color:rgb(146,182,219);'> </div>"))
                callFreqdiv = ("<div class='numberCircle' style='visibility:hidden;'>" + item.callFreqCount + "</div>")
            }
        } else {
            Parentdiv = $("<div id='MainDiv-" + item.AllCallsReg_key + "' class='col-md-12  clickable parentdiv maindiv opendetail' onmouseover='hoverId(this)' onmouseout='hoverNot(this)' style='background-color:rgb(255 ,170, 170);'></div>");
            MoreDetailsdiv = $(("<div  class='MoreDetails' id='" + item.AllCallsReg_key + "'  style='opacity:1;background-color:rgb(255, 170, 170);'> </div>"))
            callFreqdiv = ("<div class='numberCircle' style='visibility:hidden;'>" + item.callFreqCount + "</div>")
        }
        if (item.callFreqCount > 0) {
            /*Parentdiv = $("<div id='MainDiv-" + item.AllCallsReg_key + "' class='col-md-12  clickable parentdiv red maindiv opendetail' onmouseover='hoverId(this)' onmouseout='hoverNot(this)'></div>");*/
            //MoreDetailsdiv = $(("<div  class='MoreDetails' id='" + item.AllCallsReg_key + "'  style='background-color:#cce6ff;opacity:1;color: white;width:  510px;display: none;'> </div>"))
            Parentdiv = $("<div id='MainDiv-" + item.AllCallsReg_key + "' class='col-md-12  clickable parentdiv red maindiv opendetail' onmouseover='hoverId(this)' onmouseout='hoverNot(this)' style='background-color:rgb(255 ,170, 170);'></div>");
            MoreDetailsdiv = $(("<div  class='MoreDetails' id='" + item.AllCallsReg_key + "'  style='background-color:rgb(255 ,170, 170);opacity:1;width:  510px;display: none;'> </div>"))
        ...
        div.html(callFreqdiv
            + " " + ("<input type='checkbox' onclick='chkCheckUncheck(this)' class='checkboxall' id='" + item.P_AllCallsReg + "' value='" + item.P_AllCallsReg + "' style='margin-top: 0px;margin-right:10px;'/>")
            ...
            + " " + ("<div class='combineCol firm opendetail' style='width:18%;'>"
            ...
            + " " + ("<div style='width:9%;text-align:left; word-break:break-word; font-size: 13px !important;' class='location basicTr clampTr'>" + item.Location + "</div>")
            ...
            //+ " " + ("<div style='width:8%;padding-right: 10px;' class='issuetype basicTr' data-issuetype='" + item.Issuetype + "'>" + item.TextIssuetype + "</div>")
            //+ " " + ("<div style='width:10%;padding-left:0px; text-align:left;' class='issuedescription basicTr'>" + item.Issuedescription + "</div>")
            ...
            + " " + ("<div style='width:8%;' class='basicTr nextactiondate'>" + item.FrmtNextActionDate + "</div>")
            + " " + ("<div style='display:none' class='emailId'>" + item.EmailId + "</div>")
            + " " + ("<div style='display:none' class='priorityOrder'>" + item.PriorityOrder + "</div>")
            + " " + ("<div style='display:none' class='TxtEmpAssigned'>" + item.TxtEmpAssigned + "</div>")
            + " " + ("<div style='display:none' class='TxtBilledUpto'>" + item.TxtBilledUpto + "</div>")
            + " " + ("<div style='display:none' class='combinedAddress'>" + item.combinedAddress + "</div>")
            + " " + ("<div style='display:none' class='CustEmail'>" + item.Email + "</div>")
            + " " + ("<div style='display:none' class='Custcode'>" + item.Custcode + "</div>"));
        ...
        for (var i = 0; i <= infoStringArray.length - 1; i++) {
            ...
            if (itemtext.toLocaleLowerCase() == "call engage") {
                if (itemEnable.toLocaleLowerCase() == "y") {
                    moreDetailsDivHtml += "<a  data-toggle='Call Engage'> <img src='/images/call engage.png' class= 'ShowCallEngageCtrls' onclick='CallEngagectrls(this)' data-placement='bottom' style='height:22px; width:22px; margin-top:1px'></a>";
                ...
                if (itemEnable.toLocaleLowerCase() == "y") {
                    ...
                    moreDetailsDivHtml += "<a data-toggle='Add Progress Note'  ><img src='/images/add-progress-note.png' class='AddRemarkCtrl' onclick='AddRemarkCtrl(this);' data-placement='bottom'></a>";
                    ...
                    moreDetailsDivPopoverDiv += "<div class='popover_content_wrapper11' style='display:none; z-index:12; width:70px; margin-top:0px; padding-top:0px' id='AddRemarkCtrlDiv' class='AddRemarkCtrlDiv'><span class='close' onclick='popoverClose();' style=' font-size:15px; text-align:right; padding-left:15px;padding-bottom:0px;'> &times; </span>     <div class='col-md-12' style='height: 160px;margin-top: 10px;padding-left:0px;display:contents'>Progress Note <textarea id='AddRemarkCtrl-" + item.AllCallsReg_key + "' name='AddRemarkCtrl' class='col-md-9 AddRemarkInput' type='text' style='width: 100%;color: black;margin-top: 5px;height: 95px;padding: 5px;border-radius: 4px; margin-bottom:5px;' /><input type='file' name='popoverremarkfile' id='popoverremarkfile' style='display: inline-block; color: #0F5FAF; outline:none; color:white; font-size:10px; width:240px;'><div class='btn btn-success' id='popoverRemarkSubmit' onclick='SubmitCallRemark(this)' style='width: auto; float: right; padding: 2px 8px 3px 8px;font-size: 12px;margin: 0px 0px 0px 0; height:22px;'>Submit</div></div></div> ";
                }
            }
            else if (itemtext.toLocaleLowerCase() == "view remarks") {
                if (itemEnable.toLocaleLowerCase() == "y") {
                    //moreDetailsDivHtml += "<a data-toggle='View Remarks' class='ShowRemark'><i class='glyphicon glyphicon-list ShowRemark' data-placement='left' style='font-size:17.75px; color:#616A6B; padding-left:11px;'  onclick='ViewRemarks(this)'></i></a>";
                    moreDetailsDivHtml += "<a data-toggle='View Progress Notes' class='ShowRemark' style='width:25px'><img src='/images/4.0.png' class= 'ShowRemark' data-placement='left' onclick='ViewRemarks(this)'></i></a>";
                ...
                if (itemEnable.toLocaleLowerCase() == "y") {
                    moreDetailsDivHtml += "<a data-toggle='Go To Call Dashboard' href='/CustomerDetails/Calldashboard?CallId=" + item.P_AllCallsReg + "' > <img src='/images/dashboard.png' style='height:22px; width:22px; margin-top:2px;'></a>";
                }
            }
            else if (itemtext.toLocaleLowerCase() == "edit") {
                if (itemEnable.toLocaleLowerCase() == "y") {
                    moreDetailsDivHtml += "<a data-toggle='Edit&nbsp&nbsp&nbsp' href='/CRM/EditRegCalls?P_allCallReg=" + item.P_AllCallsReg + "&CalledFrom=ManageRegCalls' id='Edit' style='padding:0 0 0 5px'><img src='/images/edit2.png' style='width: 21px;' ></a>";
                }
            }
            else if (itemtext.toLocaleLowerCase() == "call transfer to lead") {
                if (itemEnable.toLocaleLowerCase() == "y") {
                    moreDetailsDivHtml += "<a data-toggle='Call Transfer to Lead' onclick='CallTransferToLead(" + item.AllCallsReg_key + ")' style='width:25px;'> <img src='/images/call transfer to lead.png' style= 'height:29px; width:30px; margin-top:-1px;'></a>";
                }
            }
            else if (itemtext.toLocaleLowerCase() == "call closed") {
                if (itemEnable.toLocaleLowerCase() == "y") {
                    moreDetailsDivHtml += "<a data-toggle='Call Closed' onclick='CallClose(" + item.AllCallsReg_key + ")' style='width:28px;'> <img src='/images/9.png' style='height:32px; width:32px; margin-top:-3px;'></a>";
                }
            }
            else if (itemtext.toLocaleLowerCase() == "onsite service") {
                if (itemEnable.toLocaleLowerCase() == "y") {
                    moreDetailsDivHtml += "<a data-toggle='Onsite Service' style='width:22px;'><img src='/images/10.png' class='OnsiteVisitCtrls' onclick='OnsiteVisitCtrls(this)' data-placement='bottom' style='height:30px; margin-top:-2px;'></a>";
                    moreDetailsDivPopoverDiv += "<div class='popover_content_wrapper10'style='display:none; z-index:12; width:70px; margin-top:0px; padding-top:0px' id='OnsiteVisitDiv'><span class='close' onclick='popoverClose();'  style='font-size:15px; text-align:right;'> &times; </span>     <div class='col-md-12' style='padding-left:0px;text-align: center;padding-right:0;'>Current Onsite Visits:<span id='onsitespan-" + item.AllCallsReg_key + "'></span> <br> <p style='color: grey;margin: 0px;padding-top: 8px;'>Do you want to register Onsite Service</p> </br><hr style='margin-bottom: 3px; width: 200px;border-top-width: 2px;margin-left: 0px;'> <div class='col-md-3 btn btn-primary' id='Yes' onclick='submitOnsiteVisit(this)' style='padding: 2px 5px 0px 5px; top:0px; margin-left: 58px;width: 105px;font-size: 12px;'> Register Visit</div></div></div> ";
                }
            }
            else if (itemtext.toLocaleLowerCase() == "defercall") {
                if (itemEnable.toLocaleLowerCase() == "y") {
                    moreDetailsDivHtml += "<a data-toggle='DeferCall' style='width:24px;'> <img src='/images/defer call.png' class='ShowDefferCallCtrls' onclick='DeferCallctrls(this)' data-placement='bottom' style='height:30px; width:30px; margin-top:-2px;'></a>";
                    moreDetailsDivPopoverDiv += "<div class='popover_content_wrapper7' style='display:none;z-index:12; width:70px; margin-top:0px; padding-top:0px' id='ShowDefferCallControlDiv'><span class='close' onclick='popoverClose();' style=' font-size:15px; text-align:right; padding-left:0px;padding-bottom:0px;'> &times; </span><div class='col-md-11' style='height: 55px;padding-left:0px; padding-right: 0px;'>Date <input id='NextActionDate' name='NextActionDate' class='NextActionDate col-md-9' type='datetime-local' style='width:100%; max-width: 85% !important; color:black; margin-top: 5px;margin-right: 5px;padding: 2px;border-radius: 3px;outline: none;border: 1px solid;' /><div class='col-md-3 btn btn-success DateBtn' id='DefferDate' onclick='defferCallSubmit(this)' style='border-radius: 50%; padding-top: 1px;padding-bottom: 0px;padding-right:2px; padding-left:1px;width: 20px; height:20px; margin-top:9px; margin-left:4px;'><i class='glyphicon glyphicon-ok' class='IconClose'></i></div></div></div> ";
                }
            }
            else if (itemtext.toLocaleLowerCase() == "contact customer") {
                if (itemEnable.toLocaleLowerCase() == "y") {
                    moreDetailsDivHtml += "<a data-toggle='Contact Customer' style='width:26px;'><img src='/images/contact.png' class='ContactCustomerCtrls' onclick='ContactCustomerCtrls(this)' data-placement='bottom' style='height:34px; width:32px; margin-top:-4px;'> </a>";
                ...
                if (itemEnable.toLocaleLowerCase() == "y") {
                    moreDetailsDivHtml += "<a data-toggle='Mark Duplicate' style='width:27px;'><img src='/images/clone-icon.png' class= 'MarkDuplicateCtrls' onclick='MarkDuplicateCtrls(this)' data-placement='bottom'  style='height:33px; width:32px; margin-top:-4px;'></a>";
                ...
                if (itemEnable.toLocaleLowerCase() == "y") {
                    moreDetailsDivHtml += "<a data-toggle='Collaborators' style='width:23px;'><img src='/images/user-icon.png' class='ShowCollaboratorCtrls' data-placement='bottom' onclick='ShowCollaboratorCtrls(this)' style='height:30px; margin-top:-2px;'></a>";
        ...
        if (item.p_customers>0) {
            moreDetailsDivHtml += "<a data-toggle='Go To Customer Dashboard' href='/CustomerDetails/Index?P_Customers=" + item.p_customers + "' > <img src='/images/dashboard.png' style='height:22px; width:22px; margin-top:2px;'></a>";
        }
        

        moreDetailsDivHtml += "<a data-toggle='Customize HoverStrip' href='/Configuration/ManageViewSettings?infotype=hoverstripstring&viewid=manageregcalls'><img src='/images/setting-icon.png' style='height:29px; width:29px; margin-top:-2px;'></a>";
...
$(document).ready(function () {
    ...
    var s = "<p class='newTitle' > Manage ServiceRequests</p>";
    ...
    $('#example').on('dblclick', '.u', function (e) {
    ...
    $('#example').on('dblclick', '.u', function () {
        var isSomethingTrue = true;
        if (isSomethingTrue && ($(window).width() <= 600)) {
            //$("#dropdown").addClass("setStyle");
            $(".right").css("display", "flex")
...
function SetDetailPane($row, destination) {
    ...
    var $TxtBilledUpto = $row.find(".TxtBilledUpto").text();
    var $TxtEmpAssigned = $row.find(".TxtEmpAssigned").text();
    var $combinedAddress = $row.find(".combinedAddress").text();
    var $CustEmail = $row.find(".CustEmail").text();
    var $Custcode = $row.find(".Custcode").text();
    ...
    $(destination + "   #billedupto").text($TxtBilledUpto);
    $(destination + "   #txtempassigned").text($TxtEmpAssigned);
    $(destination + "   #custAddress").text($combinedAddress);
    $(destination + "   #CustEmail").text($CustEmail);
    $(destination + "   #txtCustCode").text($Custcode);
...
$(document).ready(function () {
    ...
    $("#Prev").on("click", function () {
        ...
        $('#Msg').hide();
        if (d >= 0) {
            $.post('/CRM/AjaxGetJsonDataSortManageRegCalls', { start: d, pSize: a, search: b, order: o, ServerOrderValue: "" }, function (data) {
                loadData(data);
            })
        }
    });
    $("#Next").on("click", function () {
        ...
        $('#Msg').hide();
        if (d < total) {
            $.post('/CRM/AjaxGetJsonDataSortManageRegCalls', { start: d, pSize: a, search: c, order: o, ServerOrderValue: "" }, function (data) {
                loadData(data);
            })
        }
    });
...
function ShowLinkCustomerModal(CallId, Mobileno) {
    ...
    //Added by aslam
    $("#linkCustomerForm #FirmName1").val("");
    $("#linkCustomerForm #P_Customers").val("");
...
function ViewRemarks(ctrl) {
    ...
    var more1 = $("<div class='' style='display:flex; position:absolute; padding-right: 0px; z-index:10; margin-right:0px; margin-bottom:40px; width: 450px; height:46px; color: #325faf; padding-left:0px; background-color:white;' id='SRTitle'  ></div>");
    ...
    var more = $("<div class='col-md-12' style='display:flex; top: 55px; position:absolute; width: 93%; margin-right:0px; padding-right: 0px; z-index:10; margin-bottom:45px;height:20px; color: #325faf; padding-left:0px; ' id='SRTitle'  ></div>");
    more.html(("<div class='' style='width:10%; text-align:left; padding-top:0px; margin-bottom:5px; padding-left: 0px;'><b>Sno.</b></div>")
        + " " + ("<div class='' style=' width:40%;padding-left: 0px; padding-top:0px; margin-bottom:5px; padding-right:0px; text-align:left;'><b>Remark</b></div>")
        + " " + ("<div class='' style='width:15%; text-align: left;padding-top:0px;margin-bottom: 5px;padding-right: 0px;padding-left: 0px; margin-left: 0px;' > <b>Comm. type</b> </div>")
        + " " + ("<div class='' style=' width:15%; text-align: left;padding-top:0px;margin-bottom: 5px;padding-right: 0px;' ><b>Date</b> </div>")
    ...
    var more2 = $("<div class='col-md-12 ShowRemarksValueM' style='margin-bottom:72px' id='' ></div>");
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            //$(".popover-content #LoadingData").css('display', 'none');
            var a = 1;
            var divContainer = $("<div class='col-md-12' style='z-index:12;color:black;padding-top:15px padding-left:0px;  margin-top:30px; overflow-y:scroll; height:150px; padding:0;'></div>");

            $.each(data.data, function (index, item) {
                var m = (a) + index;
                var more1 = $("<div class='col-md-12'  style='width:100%; position:relative; display:flex;margin-bottom:10px;color:black; margin-top:10px;padding:0; ' id='" + item.CRMCommunication_key + "'>" + m + "</div>");
                more1.html(("<div class='col-md-1' style='width:10%; margin-left: 0px; padding-left: 0px;  text-align:left;'>" + m + "</div>")
                    + " " + ("<div class='col-md-3' style='width:40%;padding-left:0px; padding-right:10px;text-align:left;' >" + item.Commtext + "</div>")
                    + " " + ("<div class='col-md-1' style='width:15%;  text-align:left; padding-right:0px; padding-left:0px; margin-left:0px;'  >" + item.TextCommunicationType + " </div>")
                    + " " + ("<div class='col-md-3' style='width:15%; text-align:left; padding:0;'>" + item.FrmtCreationDate + " </div>")
    ...
    $('.popover.fade.left.in').css('left', '-675px');
...
function OnsiteVisitCtrls(ctrl) {
    ...
    $('.popover-content').css('flex-direction', 'row-reverse');
...
function AddRemarkCtrl(ctrl) {
    ...
    $(".AddRemarkCtrl").parent().find(".bottom.in").css("max-width", "500px")
    ...
    $('.popover-content').css('padding-right', '10px');
    $('.popover-content').css('padding-left', '10px');
    $('.popover-content').css('padding-top', '3px');
...
function CancleEditCall(destination) {
    ...
    $(destination + " #FirmContainer").hide();
...
//Show Confirmation PopUp modal before delete Calls
function ShowMultiCallDeleteModal() {
    var callids = "";
    ...
    if ($.trim(callids) !== "") {
        $("#MultiCallDeleteModal").modal(options);
        $("#MultiCallDeleteModal").modal("show");
        $("#MultiCallDeleteModal #callids").val(callids);
    }
    else {
        ShowMsg("Please select at least 1 Call.", "error");
    }
...
function DeleteMultipleCalls() {
    var callids = $("#MultiCallDeleteModal #callids").val();
    $("#MultiCallDeleteModal").modal("hide");
    $.post('/CRM/MultilpleCallDelete', { callIds: callids }, function (data) {
        if (data == "") {
            window.location.href = "/Home/LogOut";
            return true;
        }
...
$(function () {
    ...
    $.contextMenu.types.DefferCall1 = function (key, options, item, opt, root) {
        ...
        //}
        $('<span>Date'
            + ' <input id="NextActionDateContext" name="NextActionDate" type="datetime-local" style="width:85%; max-width:100px; margin:0 6px; color:black" /><div class="btn btn-success DateBtn" id="DefferDate" style="width:26px; border-radius:50%;"><i class="glyphicon glyphicon-ok"></i></div>')
            .appendTo(this)
                ...
                callback: function (key, options) {
                    ...
                    switch (key) {
                        ...
                        case "ShowLinkCustomerModal":
                            ...
                            //Added by aslam
                            ShowLinkCustomerModal(CallPid, Mobileno);
                            break;
