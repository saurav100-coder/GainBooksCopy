...
$(document).ready(function () {
    ...
    $("#cardsDiv").scroll(function () {
        if (($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) && (recordsTotal > $("#cardsDiv .card").length) && $("#cards .loader").length == 0 ) {
            ...
            $.post('/Invoices/ProductInfoGet', { start: start, search: prodSearch, pSize: pSize }, function (resdata) {
...
function GetData(search) {
    $.post('/Invoices/ProductInfoGet', { start: 0, search: search, pSize: pSize }, function (resdata) {
        var data = JSON.parse(resdata);
        recordsTotal = data.recordsTotal;
        loadData(data);
